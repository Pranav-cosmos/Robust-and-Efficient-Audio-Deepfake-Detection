...
- MFCC+SimpleCNN-XGBoost has the best current EER-runtime trade-off among completed models.
...
- The best hybrid model improves over plain MFCC-XGBoost by 5.00 EER percentage points.
